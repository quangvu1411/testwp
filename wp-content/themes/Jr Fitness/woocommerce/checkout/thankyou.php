...
<!--                             <h2>Your order has been placed successfully!</h2> -->
                            <div class="order-detail w-50">
                                <div class="sub-thankyou">Thank you for purchasing with organic basket. A confirmation email has been sent to you.</div>
                                <div class="order-num mb-4">Order Number: #<?php echo $order->get_order_number(); ?></div>
