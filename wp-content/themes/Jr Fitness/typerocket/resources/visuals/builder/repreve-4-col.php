...
if (!empty($data['column_number'])) {
	$column_number = 12 / $data['column_number'];
} else {
	$column_number = 4;
}
...
if(is_page(5) || $data['container']){
	$class = 'container-bigger';
} else {
	$class = 'container';
}
?>
<section class="section section-repreve-4-col section-padding" data="repreve-4-col.php" style="background-color: <?php echo $data['bg_color_section']; ?>;background-image: url(<?php echo get_attachment($data['background'])['src']; ?>);background-repeat: no-repeat;background-position: <?php echo $data['background_position']; ?> ;background-size: 100% auto; <?php echo $padding_top . $padding_bottom . $padding_left . $padding_right; ?>">
	
	<div class="<?php echo $class; ?>">
		<div class="title-section text-center cherlotte-font" <?php //echo zoom_in(1); ?>>
			<?php echo $data['title']; ?>
		</div>
		<div class="block-content">
			<div class="row">
				...
				?>
						<div class="col-12 col-lg-<?php echo $column_number; ?> mb-4">
							<!-- 						<div class="col-12 col-lg-4 mb-4"> -->
							<div class="item h-100" <?php //echo fade_up($n); ?>>
								<div class="bg-img mask h-100">
									<img src="<?php echo get_attachment($item['thumbnail'])['src']; ?>" alt="" class="img-cover">
									
									<div class="content">
									<div class="title-section text-white <?php echo $f_class; ?>"><?php echo $item['title']; ?></div>
									<?php if (!empty($item['link_button'])) { ?>
										<div class="btn-group"><a class="btn-main <?php echo $btn_class; ?>" href="<?php echo $item['link_button']; ?>"><?php echo $item['text_button']; ?></a></div>
									<?php } ?>
								</div>
