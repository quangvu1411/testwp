...
[Admin Demo](https://berocket.com/product/woocommerce-brands?utm_source=wordpress_org&utm_medium=admin_demo&utm_campaign=product_brand#try-admin) - Get access to this plugin's admin and see how it works from the inside. Change things and watch how they work.

= Premium plugin video =
[youtube https://youtu.be/lATsHNMWpgM]
*Video with the free plugin version is not available at the moment, but we are working on it*
